...
fetch('https://team-project-ye8t.onrender.com/api/auth/trailers')
    .then(res => res.json())
    .then(data => {
...
async function fetchTrailers() {
    try {
        const response = await fetch('https://team-project-ye8t.onrender.com/api/auth/trailers');
...
document.getElementById('login-form').addEventListener('submit', async (e) => {
  ...
  try {
      const response = await fetch('https://team-project-ye8t.onrender.com/api/auth/login', {
          method: 'POST',
...
function showSignupForm(email = '', password = '') {
  ...
  document.getElementById('signup-form').addEventListener('submit', async (e) => {
      ...
      try {
          const response = await fetch('https://team-project-ye8t.onrender.com/api/auth/register', {
              method: 'POST',
              headers: { 'Content-Type': 'application/json' },
